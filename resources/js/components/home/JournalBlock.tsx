                  ...
                  return (
                    <li key={post.id} className="border-t border-line first:border-t-0">
                      ...
                      >
                        ...
                        <ArrowUpRight
                          className="mt-1 h-4 w-4 shrink-0 text-faint transition-transform duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-brand"
                          aria-hidden="true"
                        />
                      </Link>
                    </li>
