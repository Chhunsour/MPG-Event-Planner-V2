...
values
  ...
  (
    ...
    '{"en":"<h2>Seminar & Corporate Event Planning</h2><p>Conferences, annual general meetings, gala dinners, team building, and professional business forums in Phnom Penh.</p><figure><img src=\"/images/mpg/project-7.png\" alt=\"Corporate Gala Dinner Setup\" /><figcaption>Corporate Banquet & Gala Stage Production, Phnom Penh</figcaption></figure>","km":"<h2>សិក្ខាសាលា និងកម្មវិធីសាជីវកម្ម</h2><p>សន្និសីទ អង្គប្រជុំសាមញ្ញប្រចាំឆ្នាំ ពិធីជប់លៀងអាហារពេលល្ងាច សកម្មភាពស្អាងក្រុម និងវេទិកាអាជីវកម្ម។</p>","zh":"<h2>研讨会与企业活动</h2><p>会议、股东年会、晚宴、团队建设与商务论坛。</p>"}'::jsonb,
    '/images/mpg/service-seminar.webp',
    array['/images/mpg/service-seminar.webp', '/images/mpg/project-7.png', '/images/mpg/about-team.png'],
...
values
  ...
  ('corporate-ceremony',
   ...
   '{"en":"<h2>Corporate Ceremony & Awards Night</h2><p>Stage build, lighting design, sound and programme management in Phnom Penh ballroom.</p><figure><img src=\"/images/mpg/project-7.png\" alt=\"Corporate Gala Stage Lighting\" /><figcaption>Corporate Awards Gala Dinner Stage & Lighting, Phnom Penh</figcaption></figure>","km":"<h2>ពិធីសាជីវកម្ម និងរាត្រីប្រគល់រង្វាន់</h2><p>ការសាងសង់ឆាក ការរចនាពន្លឺ សំឡេង និងការគ្រប់គ្រងកម្មវិធី</p>","zh":"<h2>企业典礼与颁奖之夜</h2><p>舞台搭建、灯光设计、音响与流程管理</p>"}'::jsonb,
   'Corporate', 'Cambodia', '/images/mpg/contact-quote.webp',
   array['/images/mpg/project-7.png', '/images/mpg/contact-quote.webp', '/images/mpg/about-team.png'],
  ...
  ('conference-summit',
   ...
   '{"en":"<h2>Conference & Business Summit Production</h2><p>Wide LED screen, stage lighting, conference sound and seating in Phnom Penh.</p><figure><img src=\"/images/mpg/service-seminar.webp\" alt=\"Business Conference Stage Presentation\" /><figcaption>Business Forum Keynote Stage & Sound Setup, Phnom Penh</figcaption></figure>","km":"<h2>សន្និសីទ និងវេទិកាអាជីវកម្ម</h2><p>អេក្រង់ LED ធំ ពន្លឺឆាក សំឡេងសន្និសីទ និងកៅអី</p>","zh":"<h2>会议与商务峰会</h2><p>宽幅 LED 屏幕、舞台灯光、会议音响与座位</p>"}'::jsonb,
   'Corporate', 'Cambodia', '/images/mpg/service-seminar.webp',
   array['/images/mpg/service-seminar.webp', '/images/mpg/project-6.png', '/images/mpg/about-team.png'],
...
values
  (
    ...
    '{"en":"Planning a landmark grand opening in Phnom Penh","km":"ការរៀបចំពិធីបើកសម្ពោធដ៏សំខាន់នៅភ្នំពេញ","zh":"如何在金边策划舆一场标志性的开业典礼"}'::jsonb
  ),
  (
